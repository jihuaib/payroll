...
<head>
    ...
    <script type="text/javascript">
        ...
        function selectedSubmitOption() {
            $(".menu_option_right option").prop("selected","selected");
            $("#permission_option_right option").prop("selected","selected");
        }

        $(function () {
            //处理菜单移动
            //全部右移
            $("#menu_moveAllRight").click(function () {
                $(".menu_option_right").append($(".menu_option_left option"));
            });
            //左移全部
            $("#menu_moveAllLeft").click(function () {
                $(".menu_option_right option").appendTo($(".menu_option_left"));
            });
            //右移选定
            $("#menu_moveSelectedRight").click(function () {
                $(".menu_option_right").append( $(".menu_option_left option:selected"));
            });
            //左移选定
            $("#menu_moveSelectedLeft").click(function () {
                $(".menu_option_right option:selected").appendTo($(".menu_option_left"));
            });

            //处理权限移动
            //全部右移
            $("#permission_moveAllRight").click(function () {
                $("#permission_option_right").append( $("#permission_option_left option"));
            });
            //左移全部
            $("#permission_moveAllLeft").click(function () {
                $("#permission_option_right option").appendTo($("#permission_option_left"));
            });
            //右移选定
            $("#permission_moveSelectedRight").click(function () {
                $("#permission_option_right").append( $("#permission_option_left option:selected"));
            });
            //左移选定
            $("#permission_moveSelectedLeft").click(function () {
                $("#permission_option_right option:selected").appendTo($("#permission_option_left"));
            });
